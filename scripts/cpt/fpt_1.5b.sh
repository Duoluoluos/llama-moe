...
### 模型/训练参数配置（保留原配置）###
model_type="qwen2"
tokenizer_path=/hdd-cifs/wangqi/models/Qwen2.5-1.5B
dataset_dir=/hdd-cifs/wangqi/code_train_tokenized_q2.5
validation_dir=/hdd-cifs/wangqi/code_val_tokenized_q2.5
pretrained_model=/hdd-cifs/wangqi/models/Qwen2.5-1.5B
lr=3e-6
...
output_dir="/hdd-cifs/wangqi/train_outputs/${job_name}-${timestamp}"
mkdir -p $output_dir
